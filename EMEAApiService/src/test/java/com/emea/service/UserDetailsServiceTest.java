...
public class UserDetailsServiceTest extends InitDb {
    ...
    public void testGetAccountDetailsWithInactiveUserData() {
        ...
        Query q = entityManager
                .createNativeQuery("INSERT INTO user_details (username,email, password, activated) VALUES ('mollah', 'hasim@abc.com', 'test', 'false')");
        q.executeUpdate();

        q = entityManager
                .createNativeQuery("INSERT INTO user_authority (username,authority) VALUES ('mollah', 'ROLE_USER')");
        q.executeUpdate();
        q = entityManager
                .createNativeQuery("INSERT INTO user_authority (username,authority) VALUES ('mollah', 'ROLE_ADMIN')");

        UserDetails userDetails = userDetailsService
                .loadUserByUsername("mollah");
    }
