...
public class ApplicationContextUtil implements ApplicationContextAware{
	...
	public static void init() throws SQLException{
        ...
        .getAbsolutePath());
		 ...
		 String contextFilePath = System.getProperty(APP_CONTEXT_PATH_STR, APP_CONTEXT_PATH_VALUE);
		 ClassPathXmlApplicationContext applicationContext = new ClassPathXmlApplicationContext(contextFilePath);
