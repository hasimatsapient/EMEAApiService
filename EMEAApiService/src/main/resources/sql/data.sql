INSERT INTO user_details (username,email, password, activated) VALUES ('admin', 'admin@mail.me', 'admin', 'true');
INSERT INTO user_details (username,email, password, activated) VALUES ('user', 'user@mail.me', 'user', 'true');
